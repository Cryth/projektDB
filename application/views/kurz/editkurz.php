<div class="col-md-6 offset-md-3">
    <div class="card card-outline-secondary">
        ...
        <div class="card-body">
            <form class="form" method="post" action="updatekurz" accept-charset="UTF-8">
                <div class="form-group">
                    <input type="hidden" class="form-control" name="idecko" id="idecko" value="<?php echo $kurz['idKurz'];?>">
                </div>
                <div class="form-group">
                    <label for="nazov">Názov</label>
                    <input type="text" class="form-control" name="nazov" id="nazov" placeholder="Názov kurzu" value="<?php echo $kurz['Nazov'];?>" required>
                </div>
                <div class="form-group">
                    <label for="popis">Popis</label>
                    <textarea class="form-control" name="popis" id="popis" placeholder="Popis kurzu" required><?php echo $kurz['Popis'];?></textarea>
                </div>
                <div class="form-group">
